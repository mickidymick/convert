...
static inline int        yed_gui_convert_row_to_screen_space(int row, yed_frame *frame);
static inline int        yed_gui_convert_col_to_screen_space(int col, yed_frame *frame);
...
static inline int yed_gui_convert_row_to_screen_space(int row, yed_frame *frame) {
    return row - frame->buffer_y_offset + frame->top;
}

static inline int yed_gui_convert_col_to_screen_space(int col, yed_frame *frame) {
    return col - frame->buffer_x_offset + frame->left + frame->gutter_width;
}
